...
import {
    CacheNone, gql, HydrogenRouteProps, Image, Link, Money, Seo, type, useLocalization,
    useRouteParams, useSession, useShopQuery
                ...
                <tfoot>
                  ...
                  <tr>
                    <th
                      scope="row"
                      colSpan={3}
                      className="hidden pt-4 pl-6 pr-3 text-right  sm:table-cell md:pl-0"
                    >
                      Total
                    </th>
                    <th scope="row" className="pt-4 pr-3 text-left  sm:hidden">
                      Total
                    </th>
                    <td className="pt-4 pl-3 pr-4 text-right  md:pr-3">
